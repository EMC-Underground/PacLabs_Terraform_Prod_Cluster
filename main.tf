...
module "SDSvm6_Disk1_eagerzero"{
  source                  = "Services/ThickEZeroVMDK"
  disk_datastore          = "${var.sdsvm6_disk1_eagerzero_datastore}"
  disk_attach_path_name   = "${var.sdsvm6_disk1_eagerzero_attach_path_name}"
  disk_size               = "${var.sdsvm6_disk1_eagerzero_disk_size}"
}

module "SDSvm6_Disk2_eagerzero"{
  source                  = "Services/ThickEZeroVMDK"
  disk_datastore          = "${var.sdsvm6_disk2_eagerzero_datastore}"
  disk_attach_path_name   = "${var.sdsvm6_disk2_eagerzero_attach_path_name}"
  disk_size               = "${var.sdsvm6_disk2_eagerzero_disk_size}"
}

module "SDSvm6_Disk3_eagerzero"{
  source                  = "Services/ThickEZeroVMDK"
  disk_datastore          = "${var.sdsvm6_disk3_eagerzero_datastore}"
  disk_attach_path_name   = "${var.sdsvm6_disk3_eagerzero_attach_path_name}"
  disk_size               = "${var.sdsvm6_disk3_eagerzero_disk_size}"
}

module "SDSvm6_Disk4_eagerzero"{
  source                  = "Services/ThickEZeroVMDK"
  disk_datastore          = "${var.sdsvm6_disk4_eagerzero_datastore}"
  disk_attach_path_name   = "${var.sdsvm6_disk4_eagerzero_attach_path_name}"
  disk_size               = "${var.sdsvm6_disk4_eagerzero_disk_size}"
}
...
module "SDSvm6"{
  ...
  disk1_attach_path  = "${var.sdsvm6_disk1_eagerzero_attach_path_name}"
  disk1_datastore    = "${module.SDSvm6_Disk1_eagerzero.disk1_datastore_id}"
  disk2_attach_path  = "${var.sdsvm6_disk2_eagerzero_attach_path_name}"
  disk2_datastore    = "${module.SDSvm6_Disk2_eagerzero.disk1_datastore_id}"
  disk3_attach_path  = "${var.sdsvm6_disk3_eagerzero_attach_path_name}"
  disk3_datastore    = "${module.SDSvm6_Disk3_eagerzero.disk1_datastore_id}"
  disk4_attach_path  = "${var.sdsvm6_disk4_eagerzero_attach_path_name}"
  disk4_datastore    = "${module.SDSvm6_Disk4_eagerzero.disk1_datastore_id}"
}
